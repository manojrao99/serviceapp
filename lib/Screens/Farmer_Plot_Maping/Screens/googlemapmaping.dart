...
class _MapScreenState extends State<MapScreenBloc>
  ...
  void alldata() {
    widget.alreadyprcent!.forEach((farmlandpolygrom) {
      ...
      // final latlangs= farmlandpolygrom!.polygonBoundaryes! as List<dynamic>;
      // final latLngList =convertStringToList(farmlandpolygrom!.polygonBoundaryes.toString());

      // return latLngList;
// }
//  print("latlangs ${latlangs}");
//   mapbondries.forEach((element) {
//     final marker = Marker(
...
//   });
                                              ...
                                              for (int j = 0;
                                                ...
                                                if (find) {
                                                  if (blocks[j]
                                                      ...
                                                      2) {
                                                    var BlockID =
                                                        await SaveBlockDetails(
                                                            widget.data[0]
                                                                .farmerID,
                                                            blocks[j].name,
                                                            Areacalculate(blocks[
                                                                    j]
                                                                .mapboundrieslat),
                                                            blocks[j]
                                                                .polygran!
  ...
  Future<int> SavePlotDetails(farmerID, Farmlandname, Totalarea, Polygron,
      farmlandid, type, lat, long) async {
